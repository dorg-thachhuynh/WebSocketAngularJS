...
public class WebSocketAngularJsApp {

    private static final Logger log = LoggerFactory.getLogger(WebSocketAngularJsApp.class);

    private final Environment env;

    public WebSocketAngularJsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes WebSocketAngularJS.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(WebSocketAngularJsApp.class);
